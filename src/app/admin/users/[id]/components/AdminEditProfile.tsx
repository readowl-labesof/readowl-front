  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-purple-900 via-purple-800 to-purple-700 px-4 py-6">
      <div className="max-w-2xl mx-auto">
        {/* Header com botão voltar - posicionado mais à esquerda */}
        ...
        {/* Card principal com cores roxas */}
          ...
          <div className="flex items-center gap-6 mb-8">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                {user.role === "ADMIN" && (
                  <span className="bg-purple-800/90 text-white text-sm px-3 py-1 rounded-full flex items-center gap-2 font-medium">
                    <Shield size={14} />
                    Admin
                  </span>
                )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white/20 border border-white/30 rounded-xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-all backdrop-blur-sm"
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 bg-white/20 border border-white/30 rounded-xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-all resize-none backdrop-blur-sm"
            ...
            <div className="flex items-center justify-between pt-6 gap-4">
              <button
                ...
                disabled={loading}
                className="flex items-center gap-2 px-6 py-3 bg-red-600/80 text-white rounded-xl hover:bg-red-600 disabled:opacity-50 transition-all duration-200 font-medium backdrop-blur-sm"
              >
                <Trash2 size={18} />
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex items-center gap-2 px-8 py-3 bg-green-600/80 text-white rounded-xl hover:bg-green-600 disabled:opacity-50 transition-all duration-200 font-medium backdrop-blur-sm"
              >
                <Save size={18} />
