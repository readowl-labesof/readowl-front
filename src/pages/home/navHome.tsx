    ...
    <header className="bg-readowl-purple-medium shadow-sm">
      <nav className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          />
          <span className="text-2xl font-bold text-readowl-purple-extralight">
            Readowl
          </span>
        </div>
        ...
        <div className="flex-1 max-w-lg mx-8">
          <Link to="/search">
            <InputWithIcon
              icon={
                <img src={searchIcon} alt="Pesquisar" className="h-5 w-5" />
              }
        ...
        <div className="flex items-center space-x-6">
          <Link
            to="/library"
            className="flex items-center text-readowl-purple-extralight hover:text-white transition-colors"
          >
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              to="/profile"
              className="text-readowl-purple-extralight hover:text-white transition-colors"
            >
              <img
                src={accountBoxIcon}
                alt="Editar usuário"
