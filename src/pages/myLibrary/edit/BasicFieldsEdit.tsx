      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            onBlur={onBlurTitle}
            className={`w-full bg-white border-2 pl-4 pr-4 py-2 focus:ring-2 focus:ring-readowl-purple-dark text-readowl-purple placeholder-readowl-purple/50 transition ${
              errors.title && (touched.title || attemptedSubmit)
                ? "border-red-400"
                : "border-white/60"
            }`}
      ...
      <div>
        ...
        <div className="relative">
          <textarea
            ...
            className={`w-full bg-white border-2 pl-4 pr-4 py-3 h-80 resize-none focus:ring-2 focus:ring-readowl-purple-dark text-readowl-purple placeholder-readowl-purple/50 leading-relaxed transition ${
              errors.synopsis && (touched.synopsis || attemptedSubmit)
                ? "border-red-400"
                : "border-white/60"
            }`}
        ...
        <div className="flex justify-between text-xs mt-1 text-white/80">
          {errors.synopsis && (touched.synopsis || attemptedSubmit) ? (
            <span className="text-red-300">{errors.synopsis}</span>
          ) : (
            <span />
          )}
          <span>
            {synopsis.length}/{BOOK_SYNOPSIS_MAX}
          </span>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full bg-white border-2 pl-4 pr-4 py-2 focus:ring-2 focus:ring-readowl-purple-dark text-readowl-purple placeholder-readowl-purple/50 transition ${
              errors.releaseFrequency && (touched.frequency || attemptedSubmit)
                ? "border-red-400"
                : "border-white/60"
            }`}
        ...
        <div className="flex justify-between text-xs mt-1 text-white/80">
          {errors.releaseFrequency && (touched.frequency || attemptedSubmit) ? (
            <span className="text-red-300">{errors.releaseFrequency}</span>
          ) : (
            <span />
          )}
          <span>
            {releaseFrequency.length}/{BOOK_FREQ_MAX}
          </span>
        </div>
      </div>
    </div>
